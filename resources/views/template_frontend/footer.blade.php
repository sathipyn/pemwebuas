        ...
        <div class="col-md-6 col-md-pull-6">
			<div class="footer-copyright">
				...
				@else
					2019 - {{ date('Y') }}
				@endif
				All rights reserved <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://github.com/adhiariyadi/" target="_blank">Adhi Ariyadi</a> | Repost by <a href='https://valcoding.com/' title='valcoding.com' target='_blank'>valcoding.com</a>
